...
namespace Microsoft.AspNet.WebHooks.Storage
{
    ...
    public class StorageManagerTests
    {
        ...
        private readonly Mock<ILogger<StorageManager>> _loggerMock;
        private readonly IStorageManager _manager;

        public StorageManagerTests()
        {
            _loggerMock = new Mock<ILogger<StorageManager>>();
        ...
        public static TheoryData<Exception, string> StorageErrorMessageData =>
            new TheoryData<Exception, string>
            {
                { null, string.Empty },
                { new Exception("你好"), "你好" },
        ...
        [Fact(Skip = "There is a bug in the https://github.com/azure/azurite that will accept invalid names for tables")]
        public void GetCloudTable_HandlesInvalidTableName()
        {
            ...
            // Assert
            Assert.StartsWith("Could not initialize connection to Microsoft Azure Storage", ex.Message);
        }
