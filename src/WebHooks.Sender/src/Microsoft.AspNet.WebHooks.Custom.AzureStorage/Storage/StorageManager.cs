...
namespace Microsoft.AspNet.WebHooks.Storage
{
    ...
    public class StorageManager : IStorageManager
    {
        ...
        /// </summary>
        public StorageManager([NotNull] ILogger<StorageManager> logger)
        {
        ...
        public CloudStorageAccount GetCloudStorageAccount(string connectionString)
        {
            ...
            try
            {
                ...
                {
                    var message = string.Format(CultureInfo.CurrentCulture, AzureStorageResources.StorageManager_NoCloudStorageAccount, nameof(CloudStorageAccount));
            ...
            var account = TableAccounts.GetOrAdd(
                ...
                key =>
                {
                    ...
                    try
                    {
                        ...
                        var _ = cloudTable.CreateIfNotExistsAsync().Result;
                    }
                    catch (Exception ex)
                    {
            ...
            var account = QueueAccounts.GetOrAdd(
                ...
                key =>
                {
                    ...
                    try
                    {
                        ...
                        var _ = cloudQueue.CreateIfNotExistsAsync().Result;
                    }
                    catch (Exception ex)
                    {
                        var error = GetStorageErrorMessage(ex);
        ...
        public async Task<long> ExecuteDeleteAllAsync(CloudTable table, string partitionKey, string filter)
        {
            ...
            catch (Exception ex)
            {
                ...
                var message = string.Format(CultureInfo.CurrentCulture,
                    AzureStorageResources.StorageManager_OperationFailed, statusCode, errorMessage);
                _logger.LogError(message, ex);
                throw new InvalidOperationException(message, ex);
            }
        }
        ...
        internal static IStorageManager GetInstance(ILogger<StorageManager> logger)
        {
