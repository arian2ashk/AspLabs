...
namespace Microsoft.AspNet.WebHooks
{
    ...
    public class AzureWebHookDequeueManager : IDisposable
    {
        ...
        private readonly ILogger<AzureWebHookDequeueManager> _logger;
        ...
        internal WebHookSender _sender;
        ...
        public AzureWebHookDequeueManager(string connectionString, [NotNull] HttpClient httpClient, [NotNull] IStorageManager storageManager, ILogger<AzureWebHookDequeueManager> logger, ILogger<WebHookSender> webHookSenderLogger)
            : this(connectionString, _DefaultFrequency, _DefaultMessageTimeout, DefaultMaxDequeueCount, httpClient, storageManager, logger, webHookSenderLogger)
        {
        }
        ...
        /// <param name="httpClient"></param>
        /// <param name="storageManager"></param>
        /// <param name="webHookSenderLogger"></param>
        internal AzureWebHookDequeueManager([NotNull] string connectionString, TimeSpan pollingFrequency, TimeSpan messageTimeout, int maxAttempts, [NotNull] HttpClient httpClient, [NotNull] IStorageManager storageManager, ILogger<AzureWebHookDequeueManager> logger, ILogger<WebHookSender> webHookSenderLogger)
        {
            ...
            _sender = new QueuedSender(this, webHookSenderLogger);

            _queue = _storageManager.GetCloudQueue(connectionString, AzureWebHookSender.WebHookQueue);
        }

        internal WebHookSender WebHookSender => _sender;
        ...
        private class QueuedSender : WebHookSender
        {
            ...
            public QueuedSender(AzureWebHookDequeueManager parent, ILogger<WebHookSender> logger)
                : base(logger)
            {
